...
export const SERVICES = {
    ...
    LIQUIDATION_DUPLICATE_MERCANTIL: process.env.CERTIFICATE,
    LIQUIDATION_SERVICE_DUPLICATE: process.env.CERTIFICATE,
    LIQUIDATION_CONTRACT_MERCANTIL: process.env.CERTIFICATE,
};
