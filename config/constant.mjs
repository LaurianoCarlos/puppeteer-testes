...
export const SERVICES = {
    ...
    LIQUIDATION_DUPLICATE_MERCANTIL: process.env.LIQUIDATION_DUPLICATE_MERCANTIL,
    LIQUIDATION_SERVICE_DUPLICATE: process.env.LIQUIDATION_SERVICE_DUPLICATE,
    LIQUIDATION_CONTRACT_MERCANTIL: process.env.LIQUIDATION_CONTRACT_MERCANTIL,
    LIQUIDATION_CPR: process.env.LIQUIDATION_CPR,
};
